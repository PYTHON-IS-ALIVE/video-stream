...
OWNER_NAME = getenv("OWNER_NAME", "Python_is_alive")
ALIVE_NAME = getenv("ALIVE_NAME", "Python")
BOT_USERNAME = getenv("BOT_USERNAME", "PYTHONMUSIC_BOT")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "PYTHONMUSICBOT_1")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "ANACONDA_ARMY")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "ANACONDA_BOTZ")
